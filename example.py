...
# apikey = "7e757d55-4942-49f3-9d63-657f5af90037"
# secretkey = "6020D2CF23706CF7F25A1E40A91EC207"
# IP = "0"
# 备注名 = "test"
# 权限 = "只读"


# apikey = "b79b1ec8-154d-4a89-a5a6-1acd1f4f79cd"
# secretkey = "E6DE443863A5429D2E059D18CD588178"
# IP = "173.242.117.99"
# 备注名 = "trade"
# 权限 = "只读/交易"
...
# 币币API
    ...
    # 账单流水查询
    # result = spotAPI.get_ledger_record(currency='USDT', after='', before='', limit='', type='')
    # 下单
    # result = spotAPI.take_order(instrument_id='ETH-USDT', side='buy', client_oid='', type='', size='0.001', price='10', order_type='0', notional='')
    # 批量下单
